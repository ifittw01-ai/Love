...
const translations = {
    ...
    'zh-CN': {
        ...
        'testimonial-3-name': '严小姐',
        'testimonial-3-role': '照顾者',
        'testimonial-3-text': '我最需要的是「陪长辈怎么做」。这套把流程变简单，很开心遇到AI大脑回春系统，还可以学会最先进的AI能力，真的太棒了。',
        'faq-title': '常见问题',
        'faq-q1': '可以试试看吗？',
    ...
    'en': {
        ...
        'after-3': '✅ AI reminders + tracking: You can see your own progress.',
